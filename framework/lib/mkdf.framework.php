...
/*
   Class: WilmerMikadoClassFramework
...
class WilmerMikadoClassFramework {
	...
	private function __construct() {
		$this->mkdOptions         = WilmerMikadoClassOptions::get_instance();
		$this->mkdMetaBoxes       = WilmerMikadoClassMetaBoxes::get_instance();
		$this->mkdTaxonomyOptions = WilmerMikadoClassTaxonomyOptions::get_instance();
		$this->mkdUserOptions     = WilmerMikadoClassUserOptions::get_instance();
		$this->mkdDashboardOptions = WilmerMikadoClassDashboardOptions::get_instance();
	}
	...
	public function setSkin( WilmerMikadoClassSkinAbstract $skinObject ) {
		$this->skin = $skinObject;
	}
}

/**
 * Class WilmerMikadoClassSkinManager
 *
...
class WilmerMikadoClassSkinManager {
	...
	/**
	 * @see WilmerMikadoClassSkinManager::setSkin()
	 */
	...
	private function setSkin( $skinName = MIKADO_PROFILE_SLUG ) {
		if ( $skinName !== '' ) {
			if ( file_exists( get_template_directory() . '/framework/admin/skins/' . $skinName . '/skin.php' ) ) {
				...
				$skinName = ucfirst( $skinName ) . esc_html__( 'Skin', 'wilmer' );
...
/**
 * Class WilmerMikadoClassSkinAbstract
 *
 * Abstract class that each skin class must extend
 */
abstract class WilmerMikadoClassSkinAbstract {
	/**
	 * @var string
	 */
	protected $skinName;
	...
	public function loadTemplatePart( $template, $params = array() ) {
		...
		if ( $template !== '' ) {
			include( wilmer_mikado_find_template_path( 'framework/admin/skins/' . $this->skinName . '/templates/' . $template . '.php' ) );
		}
	}
	...
	public function setShortcodeJSParams() { ?>
		<script>
			window.mkdSCIcon = '<?php echo wilmer_mikado_get_skin_uri() . '/assets/img/admin-logo-icon.png'; ?>';
			window.mkdSCLabel = '<?php echo esc_html( ucfirst( $this->skinName ) ); ?> <?php esc_html_e( 'Shortcodes', 'wilmer' ) ?>';
		</script>
	<?php }
...
/*
   Class: WilmerMikadoClassOptions
...
class WilmerMikadoClassOptions {
	...
	public function getOptionValue( $key ) {
		...
		if ( array_key_exists( $key, $wilmer_mikado_global_options ) ) {
			return $wilmer_mikado_global_options[ $key ];
...
/*
   Class: WilmerMikadoClassAdminPage
   A class that initializes Mikado Admin Page
*/
class WilmerMikadoClassAdminPage implements iWilmerMikadoInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $slug;
	public $title;
	...
	function __construct( $slug = "", $title = "", $icon = "" ) {
		$this->layout  = array();
		$this->factory = new WilmerMikadoClassFieldFactory();
		$this->slug    = $slug;
		$this->title   = $title;
		$this->icon    = $icon;
	}
	...
	public function renderChild( iWilmerMikadoInterfaceRender $child ) {
		$child->render( $this->factory );
	}
}

/*
   Class: WilmerMikadoClassMetaBoxes
...
/*
   Class: WilmerMikadoClassMetaBox
   A class that initializes Mikado Meta Box
*/
class WilmerMikadoClassMetaBox implements iWilmerMikadoInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	public $title;
	...
	public function setTitle( $label ) {
		...
		return $wilmer_mikado_global_Framework->getSkin()->getSkinLabel() . ' ' . $label;
	}
}

/*
   Class: WilmerMikadoClassTaxonomyOptions
   A class that initializes WilmerMikadoClass Taxonomy Options
*/
class WilmerMikadoClassTaxonomyOptions {
	private static $instance;
...
/*
   Class: WilmerMikadoClassTaxonomyOption
   A class that initializes WilmerMikadoClass Taxonomy Option
*/
class WilmerMikadoClassTaxonomyOption implements iWilmerMikadoInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	...
	function __construct( $scope = "" ) {
		$this->layout  = array();
		$this->factory = new WilmerMikadoClassTaxonomyFieldFactory();
		$this->scope   = $scope;
	}
...
/*
   Class: WilmerMikadoClassUserOptions
   A class that initializes WilmerMikadoClass User Options
*/
class WilmerMikadoClassUserOptions {
	private static $instance;
	public $userOptions;
...
/*
   Class: WilmerMikadoClassUserOption
   A class that initializes WilmerMikadoClass User Option
*/
class WilmerMikadoClassUserOption implements iWilmerMikadoInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	...
	function __construct( $scope = "" ) {
		$this->layout  = array();
		$this->factory = new WilmerMikadoClassUserFieldFactory();
		$this->scope   = $scope;
	}
...
/*
   Class: WilmerMikadoClassDashboardOptions
   A class that initializes WilmerMikadoClass Dashboard Options
*/
class WilmerMikadoClassDashboardOptions {
	private static $instance;
...
/*
   Class: WilmerMikadoClassDashboardOption
   A class that initializes WilmerMikadoClass Dashboard Option
*/
class WilmerMikadoClassDashboardOption implements iWilmerMikadoInterfaceLayoutNode {
	public $layout;
	private $factory;
	
	function __construct() {
		$this->layout        = array();
		$this->factory       = new WilmerMikadoClassDashboardFieldFactory();
	}
...
if ( ! function_exists( 'wilmer_mikado_init_framework_variable' ) ) {
	function wilmer_mikado_init_framework_variable() {
		global $wilmer_mikado_global_Framework;
		
		$wilmer_mikado_global_Framework = WilmerMikadoClassFramework::get_instance();
		$mkdSkinManager                 = new WilmerMikadoClassSkinManager();
		$wilmer_mikado_global_Framework->setSkin( $mkdSkinManager->getSkin() );
	}
	
	add_action( 'wilmer_mikado_action_before_options_map', 'wilmer_mikado_init_framework_variable' );
}
?>