...
if ( ! function_exists('wilmer_mikado_contact_form_7_options_map') ) {

	function wilmer_mikado_contact_form_7_options_map() {
		
		wilmer_mikado_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'wilmer' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = wilmer_mikado_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'wilmer' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = wilmer_mikado_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'wilmer' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'wilmer' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = wilmer_mikado_add_admin_row(
			array(
		...
		wilmer_mikado_add_admin_field(array(
			...
			'default_value' => '',
			'label'         => esc_html__( 'Placeholder Text Color', 'wilmer' ),
		));
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'wilmer' ),
			)
		);
		...
		$typography_text_row2 = wilmer_mikado_add_admin_row(
			array(
		...
		$typography_text_row3 = wilmer_mikado_add_admin_row(
			array(
		...
		$typography_label_group = wilmer_mikado_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'wilmer' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'wilmer' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = wilmer_mikado_add_admin_row(
			array(
		...
		$typography_label_row2 = wilmer_mikado_add_admin_row(
			array(
		...
		$background_border_group = wilmer_mikado_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'wilmer' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'wilmer' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = wilmer_mikado_add_admin_row(
			array(
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'wilmer' )
			)
		);
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'wilmer' )
			)
		);
		
		$background_border_row2 = wilmer_mikado_add_admin_row(
			array(
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'wilmer' ),
			)
		);
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'wilmer' )
			)
		);
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'wilmer' )
			)
		);
		
		$background_border_row3 = wilmer_mikado_add_admin_row(
			array(
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'wilmer' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = wilmer_mikado_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'wilmer' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = wilmer_mikado_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'wilmer' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'wilmer' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'wilmer' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'wilmer' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = wilmer_mikado_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'wilmer' ),
				'description' => esc_html__( 'Setup form elements margin', 'wilmer' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = wilmer_mikado_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top', 'wilmer' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom', 'wilmer' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'wilmer' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'wilmer' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = wilmer_mikado_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'wilmer' ),
				'description' => esc_html__( 'Setup button text typography', 'wilmer' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = wilmer_mikado_add_admin_row(
			array(
		...
		$button_typography_row2 = wilmer_mikado_add_admin_row(
			array(
		...
		$button_background_border_group = wilmer_mikado_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'wilmer' ),
				'description' => esc_html__( 'Setup button background and border style', 'wilmer' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = wilmer_mikado_add_admin_row(
			array(
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'wilmer' )
			)
		);
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'wilmer' )
			)
		);
		
		$button_background_border_row2 = wilmer_mikado_add_admin_row(
			array(
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'wilmer' )
			)
		);
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'wilmer' )
			)
		);
		
		$button_background_border_row3 = wilmer_mikado_add_admin_row(
			array(
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'wilmer' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		wilmer_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'wilmer' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = wilmer_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'wilmer')
		));

		//Text Typography

		$typography_text_group = wilmer_mikado_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'wilmer'),
			'description'	=> esc_html__('Setup typography for form elements text', 'wilmer'),
		...
		$typography_text_row1 = wilmer_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = wilmer_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = wilmer_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = wilmer_mikado_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'wilmer'),
			'description'	=> esc_html__('Setup typography for form elements label', 'wilmer'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = wilmer_mikado_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = wilmer_mikado_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = wilmer_mikado_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'wilmer'),
			'description'	=> esc_html__('Setup form elements background and border style', 'wilmer'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = wilmer_mikado_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = wilmer_mikado_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = wilmer_mikado_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = wilmer_mikado_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'wilmer'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = wilmer_mikado_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = wilmer_mikado_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'wilmer'),
			'description'	=> esc_html__('Setup form elements margin', 'wilmer'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = wilmer_mikado_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = wilmer_mikado_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'wilmer'),
			'description'	=> esc_html__('Setup button text typography', 'wilmer'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = wilmer_mikado_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = wilmer_mikado_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = wilmer_mikado_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'wilmer'),
			'description'	=> esc_html__('Setup button background and border style', 'wilmer'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = wilmer_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = wilmer_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = wilmer_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = wilmer_mikado_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'wilmer')
        ));
        ...
        $typography_label_row3 = wilmer_mikado_add_admin_row(array(
        ...
        $button_typography_row3 = wilmer_mikado_add_admin_row(array(
	...
	add_action( 'wilmer_mikado_action_options_map', 'wilmer_mikado_contact_form_7_options_map', wilmer_mikado_set_options_map_position( 'contact_form_7' ) );
}