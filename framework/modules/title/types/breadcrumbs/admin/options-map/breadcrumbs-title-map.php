...
if ( ! function_exists('wilmer_mikado_breadcrumbs_title_type_options_map') ) {
	function wilmer_mikado_breadcrumbs_title_type_options_map($panel_typography) {
		
		wilmer_mikado_add_admin_section_title(
			array(
				'name'   => 'type_section_breadcrumbs',
				'title'  => esc_html__( 'Breadcrumbs', 'wilmer' ),
				'parent' => $panel_typography
			)
		);
	
		$group_page_breadcrumbs_styles = wilmer_mikado_add_admin_group(
			array(
				'name'        => 'group_page_breadcrumbs_styles',
				'title'       => esc_html__( 'Breadcrumbs', 'wilmer' ),
				'description' => esc_html__( 'Define styles for page breadcrumbs', 'wilmer' ),
				'parent'      => $panel_typography
			)
		);
	
			$row_page_breadcrumbs_styles_1 = wilmer_mikado_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_2 = wilmer_mikado_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_3 = wilmer_mikado_add_admin_row(
				array(
	...
	add_action( 'wilmer_mikado_action_additional_title_typography_options_map', 'wilmer_mikado_breadcrumbs_title_type_options_map');
}