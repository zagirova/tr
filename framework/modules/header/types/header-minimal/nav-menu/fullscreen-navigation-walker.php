...
if (!class_exists('WilmerMikadoClassFullscreenNavigationWalker')) {
	class WilmerMikadoClassFullscreenNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children) {
					//$item_output .= '<i class="mkdf-fullscreen-menu-arrow icon_plus mkdf-icon-font-elegant"></i>';
				}
				$item_output .= '</a>';
			}
