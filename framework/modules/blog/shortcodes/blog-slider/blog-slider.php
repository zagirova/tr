<?php
namespace WilmerCore\CPT\Shortcodes\BlogSlider;
...
class BlogSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog Slider', 'wilmer' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							esc_html__( 'Slider', 'wilmer' )            => 'slider',
							esc_html__( 'Carousel', 'wilmer' )          => 'carousel',
							esc_html__( 'Carousel Centered', 'wilmer' ) => 'carousel-centered'
						),
						'save_always' => true
					),
					array(
						...
						'heading'    => esc_html__( 'Number of Posts', 'wilmer' )
					),
					array(
						'type'        => 'dropdown',
						'param_name'  => 'orderby',
					...
					array(
						...
						'value'      => array(
							...
							esc_html__( 'Thumbnail', 'wilmer' ) => 'thumbnail',
					...
					array(
						...
						'group'       => esc_html__( 'Post Info', 'wilmer' )
					),
					array(
						'type'        => 'dropdown',
					...
					array(
						...
						'heading'     => esc_html__( 'Enable Post Info Author', 'wilmer' ),
					...
					array(
						...
						'heading'     => esc_html__( 'Enable Post Info Date', 'wilmer' ),
						'value'       => array_flip( wilmer_mikado_get_yes_no_select_array( false, true ) ),
						'save_always' => true,
						'group'       => esc_html__( 'Post Info', 'wilmer' )
					),
					array(
						...
						'heading'     => esc_html__( 'Enable Post Info Category', 'wilmer' ),
						'value'       => array_flip( wilmer_mikado_get_yes_no_select_array( false, true ) ),
						'save_always' => true,
						'group'       => esc_html__( 'Post Info', 'wilmer' )
					),
					array(
						...
						'heading'     => esc_html__( 'Enable Post Info Comments', 'wilmer' ),
    ...
    public function blogListCategoryAutocompleteSuggester( $query ) {
        ...
        if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
            foreach ( $post_meta_infos as $value ) {
                ...
                $data['label'] = ( ( strlen( $value['category_title'] ) > 0 ) ? esc_html__( 'Category', 'wilmer' ) . ': ' . $value['category_title'] : '' );
                $results[]     = $data;
            }
        }
