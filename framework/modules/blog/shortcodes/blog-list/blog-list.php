<?php
namespace WilmerCore\CPT\Shortcodes\BlogList;
...
class BlogList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog List', 'wilmer' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							...
							esc_html__( 'Boxed', 'wilmer' )    => 'boxed',
							esc_html__( 'Masonry', 'wilmer' )  => 'masonry',
							esc_html__( 'Simple', 'wilmer' )   => 'simple',
							esc_html__( 'Minimal', 'wilmer' )  => 'minimal'
						),
						'save_always' => true
					),
                    array(
					...
					array(
						...
						'heading'    => esc_html__( 'Number of Columns', 'wilmer' ),
					...
					array(
						...
						'heading'     => esc_html__( 'Text Length', 'wilmer' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Image', 'wilmer' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Section', 'wilmer' ),
						'value'      => array_flip( wilmer_mikado_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed', 'masonry' ) ),
						'group'      => esc_html__( 'Post Info', 'wilmer' )
					),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Like', 'wilmer' ),
						'value'      => array_flip( wilmer_mikado_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'wilmer' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Share', 'wilmer' ),
						'value'      => array_flip( wilmer_mikado_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'wilmer' )
					),
					array(
						...
						'heading'    => esc_html__( 'Pagination Type', 'wilmer' ),
						'value'      => array(
							esc_html__( 'None', 'wilmer' )            => 'no-pagination',
							esc_html__( 'Standard', 'wilmer' )        => 'standard-shortcodes',
							esc_html__( 'Load More', 'wilmer' )       => 'load-more',
							esc_html__( 'Infinite Scroll', 'wilmer' ) => 'infinite-scroll'
						),
						'group'      => esc_html__( 'Additional Features', 'wilmer' )
					)
				)
			)
		);
